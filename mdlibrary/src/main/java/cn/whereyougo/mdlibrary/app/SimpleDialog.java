package cn.whereyougo.mdlibrary.app;
...
import cn.whereyougo.mdlibrary.R;
import cn.whereyougo.mdlibrary.drawable.BlankDrawable;
import cn.whereyougo.mdlibrary.widget.CheckBox;
import cn.whereyougo.mdlibrary.widget.ListView;
import cn.whereyougo.mdlibrary.widget.RadioButton;
import cn.whereyougo.mdlibrary.widget.TextView;
...
public class SimpleDialog extends Dialog {
    ...
    private class InternalAdapter extends BaseAdapter implements cn.whereyougo.mdlibrary.widget.CompoundButton.OnCheckedChangeListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            cn.whereyougo.mdlibrary.widget.CompoundButton v = (cn.whereyougo.mdlibrary.widget.CompoundButton) convertView;
            if (v == null) {
        ...
        public void onCheckedChanged(android.widget.CompoundButton v, boolean isChecked) {
            ...
            if (mMode == MODE_ITEMS && isChecked && mLastSelectedIndex != position) {
                ...
                cn.whereyougo.mdlibrary.widget.CompoundButton child = (cn.whereyougo.mdlibrary.widget.CompoundButton) mListView.getChildAt(mLastSelectedIndex - mListView.getFirstVisiblePosition());
                if (child != null)
