...
import cn.whereyougo.mdlibrary.drawable.RippleDrawable;
import cn.whereyougo.mdlibrary.util.ThemeUtil;
        ...
        public void onRtlPropertiesChanged(int layoutDirection) {
            ...
            if (mIsRtl != rtl) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    int direction = mIsRtl ? View.TEXT_DIRECTION_RTL : View.TEXT_DIRECTION_LTR;
