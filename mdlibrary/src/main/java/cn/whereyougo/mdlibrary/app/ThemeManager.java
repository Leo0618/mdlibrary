...
public class ThemeManager {
     ...
     */
    public void registerOnThemeChangedListener(@Nullable OnThemeChangedListener listener) {
     ...
     */
    public void unregisterOnThemeChangedListener(@Nullable OnThemeChangedListener listener) {
