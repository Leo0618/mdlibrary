...
import cn.whereyougo.mdlibrary.app.BottomSheetDialog;
import cn.whereyougo.mdlibrary.app.DatePickerDialog;
import cn.whereyougo.mdlibrary.app.Dialog;
import cn.whereyougo.mdlibrary.app.DialogFragment;
import cn.whereyougo.mdlibrary.app.SimpleDialog;
import cn.whereyougo.mdlibrary.app.TimePickerDialog;
import cn.whereyougo.mdlibrary.drawable.ThemeDrawable;
import cn.whereyougo.mdlibrary.util.ViewUtil;
...
public class DialogsFragment extends Fragment implements View.OnClickListener {
    ...
    private void showBottomSheet() {
        ...
        View v = LayoutInflater.from(mActivity).inflate(R.layout.layout_bottomsheet_view, null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_bt_msg_only:
                ...
                ((SimpleDialog.Builder) builder).message("Delete this conversation?").positiveAction("DELETE")
            ...
            case R.id.dialog_bt_title_msg:
                ...
                ((SimpleDialog.Builder) builder)
                        ...
                        .title("Use Google's location service?").positiveAction("AGREE").negativeAction("DISAGREE");
                break;
            ...
            case R.id.dialog_bt_choice:
                ...
                ((SimpleDialog.Builder) builder)
                        .items(new String[]{"None", "Callisto", "Dione", "Ganymede", "Hangouts Call", "Luna", "Oberon",
                                "Phobos"}, 0).title("Phone Ringtone").positiveAction("OK").negativeAction("CANCEL");
                break;
            case R.id.dialog_bt_multi_choice:
                ...
                ((SimpleDialog.Builder) builder)
                        .multiChoiceItems(
                                new String[]{"Soup", "Pizza", "Hotdogs", "Hamburguer", "Coffee", "Juice", "Milk", "Water"},
                                2, 5).title("Food Order").positiveAction("OK").negativeAction("CANCEL");
                break;
            case R.id.dialog_bt_time:
                builder = new TimePickerDialog.Builder(R.style.Material_App_Dialog_TimePicker_Light, 24, 0) {
                    ...
                    public void onPositiveActionClicked(DialogFragment fragment) {
                        ...
                        Toast.makeText(mActivity, "Time is " + dialog.getFormattedTime(SimpleDateFormat.getTimeInstance()),
